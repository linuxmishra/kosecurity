...
function jobscout_ed_author_link(){
    echo '<a class="author-link" href="' . esc_url( 'https://raratheme.com/wordpress-themes/jobscout/' ) .'" rel="author" target="_blank">' . esc_html__( ' JobScout', 'jobscout' ) . '</a>' . esc_html__( ' by Rara Theme.', 'jobscout' );
}
endif;
